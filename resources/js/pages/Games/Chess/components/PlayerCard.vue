<template>
    ...
    <!--    (currentPlayer &&-->
    <!--    currentPlayer.color &&-->
    <!--    currentPlayer.color === playerSymbol)-->
    <!--    ? '2.5px'-->
    <!--    : '0',-->
    <!--    borderBottomWidth:-->
    <!--    (!isBorderOnTop &&-->
        ...
        <div class="flex gap-3 items-start">
            ...
            <div>
                ...
                <div class="flex items-center text-gray-200 gap-2 mb-1">
                    ...
                    <!-- Country Flag -->
                    <div v-if="country" class="w-6 h-4">
                        <img
                ...
                <!-- For Chess-->
                <ul v-if="captures.length" class="flex">
                    <li v-for="(capture, index) in captures" :key="capture">
                        <div v-if="index > 0" class="ml-[-8px]">
                            <img
                                class="w-[22px]"
                                :src="capture.imgSrc"
                                alt=""
                ...
                <span class="text-white" v-if="score > 0">
                    +{{ score }}
                </span>
            </div>
        </div>
...
export default {
    props: [
        ...
        "captures",
        "score"
    ], // user (user playing), player (O or X)
